...
namespace Player
{
    ...
    public class AimRunLeft_AnimationState : GameCore.System.State
    {
        PlayerAnimator m_playerAnimator;

        public AimRunLeft_AnimationState(PlayerAnimator owner) : base(owner)
        {
        ...
        IEnumerator Transition()
        {
            ...
            {
                m_playerAnimator.Animation.CrossFade("aimRunLeft", 0.2f, PlayMode.StopAll);
            }
            else
            {
                m_playerAnimator.Animation.CrossFade("aimEraserRunLeft", 0.2f, PlayMode.StopAll);
            }
            yield return null;
        }
    }
