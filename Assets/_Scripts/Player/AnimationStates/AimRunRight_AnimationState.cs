...
namespace Player
{
    ...
    public class AimRunRight_AnimationState : GameCore.System.State
    {
        PlayerAnimator m_playerAnimator;

        public AimRunRight_AnimationState(PlayerAnimator owner) : base(owner)
        {
        ...
        IEnumerator Transition()
        {
            ...
            {
                m_playerAnimator.Animation.CrossFade("aimRunRight", 0.2f, PlayMode.StopAll);
            }
            else
            {
                m_playerAnimator.Animation.CrossFade("aimEraserRunRight", 0.2f, PlayMode.StopAll);
            }
            yield return null;
        }
    }
